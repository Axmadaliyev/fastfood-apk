...
public class ProductController {
    ...
    //getProducts By CategoryId
    @GetMapping("/all/{id}")
    public ResponseEntity getAllProductCategoryId(@PathVariable Long id){
        Optional<List<Product>> allProduct = productRepository.getAllProductsCategoryId(id);
